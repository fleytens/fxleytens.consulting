...
italy = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/ucte/it.UCT', 'r')
nodeFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/nodes/nodeit.csv', 'w+')
...
lineFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/lines/lineit.csv', 'w+')
write = csv.writer(lineFile)
write.writerow(['node1','node2','orderCode','status','resistR','reactX','susceptanceB','currentLimA','elementName'])

transformerFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/transformers/transformerit.csv', 'w+')
...
regulatorFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/regulators/regulatorit.csv', 'w+')
...
phaseshifterFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/pst/phaseshifterit.csv', 'w+')
write = csv.writer(phaseshifterFile)
write.writerow(['node1','node2','orderCode','tapPos','resistR','reactX','deltaUtapN','phaseShiftAngle'])

exchangeFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/intl/exchangeit.csv', 'w+')
