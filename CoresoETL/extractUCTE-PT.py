...
portugal = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/ucte/pt.UCT', 'r')
nodeFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/nodes/nodept.csv', 'w+')
lineFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/lines/linept.csv', 'w+')
transformerFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/transformers/transformerpt.csv', 'w+')
regulatorFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/regulators/regulatorpt.csv', 'w+')
phaseshifterFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/pst/phaseshifterpt.csv', 'w+')
exchangeFile = open('/home/fxleytens/GITPerso/fxleytens.consulting/CoresoETL/intl/exchangept.csv', 'w+')


# Create the Lines object of all lines in the file ch.UCT

Lines = portugal.readlines()
